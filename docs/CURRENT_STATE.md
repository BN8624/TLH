...
The next controlled scaling decision should treat live-limit 22 true wave as improved but still transient-sensitive. S-19 should not promote live-limit 22 to baseline; further work should consider smaller true wave sizes, adaptive retry budget, or API-side demand timing before another approved live-limit 22 run.
