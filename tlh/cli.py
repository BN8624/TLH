...
def _route_dry_run_text(payload: dict, force_backend: str | None) -> str:
    ...
    lines = [
        ...
        f"- runtime_execution_model: {wave_policy.get('runtime_execution_model', 'sequential')}",
        f"- planned_max_concurrent_live_workers: {wave_policy.get('planned_max_concurrent_live_workers', wave_policy.get('max_concurrent_live_workers', mix['live']))}",
