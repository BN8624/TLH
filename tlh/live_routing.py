...
class LiveWavePlan:
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "planned_max_concurrent_live_workers": self.max_concurrent_live_workers,
            "runtime_execution_model": "concurrent_wave" if self.enabled else "sequential",
            "actual_concurrency_limited": self.enabled,
